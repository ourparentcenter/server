...
const actions = {
	...
	getUsers(context, { offset, limit, search, group }) {
		...
		if (group !== '') {
			return api.get(generateOcsUrl('cloud/groups/{g}/users/details?offset={o}&limit={l}&search={s}', { g: encodeURIComponent(encodeURIComponent(group)), o: offset, l: limit, s: search }), {
		...
		return api.get(generateOcsUrl('cloud/users/details?offset={o}&limit={l}&search={s}', { o: offset, l: limit, s: search }), {
			cancelToken: searchRequestCancelSource.token,
		})
			.then((response) => {
				if (Object.keys(response.data.ocs.data.users).length > 0) {
	...
	getGroups(context, { offset, limit, search }) {
		...
		return api.get(generateOcsUrl('cloud/groups?offset={o}&search={s}{l}', { o: offset, s: search, l: limitParam }))
			.then((response) => {
	...
	getUsersFromGroup(context, { groupid, offset, limit }) {
		return api.get(generateOcsUrl('cloud/users/{g}/details?offset={o}&limit={l}', { g: encodeURIComponent(encodeURIComponent(groupid)), o: offset, l: limit }))
	...
	removeGroup(context, gid) {
		return api.requireAdmin().then((response) => {
			return api.delete(generateOcsUrl('cloud/groups/') + encodeURIComponent(encodeURIComponent(gid)))
	...
	enableDisableUser(context, { userid, enabled = true }) {
		...
		return api.requireAdmin().then((response) => {
			return api.put(generateOcsUrl('cloud/users/{u}/{s}', { u: userid, s: userStatus }))
